...
React Native 0.85 / TypeScript / Android 에뮬레이터 기준. 백엔드는 `../Haru_Coding_backend` (팀원 담당, 수정 금지 — 문제는 프론트 쪽에서 해결).
...
- primary 배경 위 글자는 `onPrimary`. 티어 색은 `tierColor()`.
